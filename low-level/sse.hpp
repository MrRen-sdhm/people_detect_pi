...
#define RETf static inline __attribute__((always_inline)) __m128
#define RETi static inline __attribute__((always_inline)) __m128i
...
RETf MIN_(const __m128 x, const __m128 y) {
